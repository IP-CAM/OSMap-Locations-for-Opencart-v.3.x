...
class ControllerExtensionModuleDOSMapLocations extends Controller {
    ...
    public function index() {
        $this->load->language('extension/module/dosmap_locations');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            if (!isset($this->request->get['module_id'])) {
                ...
                $this->model_setting_module->addModule('dosmap_locations', $post);
                $module_id = $this->db->getLastId();

                // Add Settings to DB.
                $config_settings = array('module_dosmap_locations_data_delete' => $post['module_dosmap_locations_data_delete']);
                ...
                $location_id = $this->model_extension_module_dosmap_locations->addLocation($this->demoData(), $module_id);
            } else {
                // Get POST data.
                $post = $this->request->post;
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/dosmap_locations', 'user_token=' . $this->session->data['user_token'] . $url, true)
        );

        $data['action'] = $this->url->link('extension/module/dosmap_locations', 'user_token=' . $this->session->data['user_token'] . $url, true);
        ...
        $data['action_add'] = $this->url->link('extension/module/dosmap_locations/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['action_open'] = $this->url->link('extension/module/dosmap_locations/open', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['action_edit'] = $this->url->link('extension/module/dosmap_locations/edit', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['action_delete'] = $this->url->link('extension/module/dosmap_locations/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['action_update_json'] = $this->url->link('extension/module/dosmap_locations/updateJSON', 'user_token=' . $this->session->data['user_token'] . $url, true);
        ...
        $results = $this->model_extension_module_dosmap_locations->getLocations($filter_data);
        ...
        $location_total = $this->model_extension_module_dosmap_locations->getTotalLocations($filter_data);
        ...
        $data['sort_location_id'] = $this->url->link('extension/module/dosmap_locations', 'user_token=' . $this->session->data['user_token'] . $url . '&sort=location_id', true);
        $data['sort_title'] = $this->url->link('extension/module/dosmap_locations', 'user_token=' . $this->session->data['user_token'] . $url . '&sort=title', true);
        $data['sort_baloon_header'] = $this->url->link('extension/module/dosmap_locations', 'user_token=' . $this->session->data['user_token'] . $url . '&sort=baloon_header', true);
        $data['sort_baloon_footer'] = $this->url->link('extension/module/dosmap_locations', 'user_token=' . $this->session->data['user_token'] . $url . '&sort=baloon_footer', true);
        $data['sort_latitude'] = $this->url->link('extension/module/dosmap_locations', 'user_token=' . $this->session->data['user_token'] . $url . '&sort=latitude', true);
        $data['sort_longitude'] = $this->url->link('extension/module/dosmap_locations', 'user_token=' . $this->session->data['user_token'] . $url . '&sort=longitude', true);
        $data['sort_status'] = $this->url->link('extension/module/dosmap_locations', 'user_token=' . $this->session->data['user_token'] . $url . '&sort=status', true);
        $data['sort_order'] = $this->url->link('extension/module/dosmap_locations', 'user_token=' . $this->session->data['user_token'] . $url . '&sort=sort_order', true);
        ...
        $pagination->limit = $data['limit_admin'];
        $pagination->url = $this->url->link('extension/module/dosmap_locations', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}&tab=locations', true);
        ...
        $data['filter_url'] = $this->url->link('extension/module/dosmap_locations', 'user_token=' . $this->session->data['user_token'] . $url, true);
        ...
        $data['filter_autocomplete'] = $this->url->link('extension/module/dosmap_locations/autocomplete', 'user_token=' . $this->session->data['user_token'] . $url, true);
        ...
        $data['filter_reset_url'] = $this->url->link('extension/module/dosmap_locations', 'user_token=' . $this->session->data['user_token'] . $url, true);
        ...
        $this->response->setOutput($this->load->view('extension/module/dosmap_locations', $data));
    }
    ...
    */
	public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate_add()) {
            ...
            $location_id = $this->model_extension_module_dosmap_locations->addLocation($this->request->post['add_location'], $module_id);
    ...
    */
	public function open() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate_open()) {
            ...
            $json['location'] = $this->model_extension_module_dosmap_locations->getLocationDescriptions($this->request->post['location_data']);
    ...
    */
	public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate_edit()) {
            ...
            $this->model_extension_module_dosmap_locations->editLocation($this->request->post['location_data']);
	...
	public function delete() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate_delete()) {
            ...
            if (isset($this->request->post['location_selected'])) {
                $this->model_extension_module_dosmap_locations->deleteLocation($this->request->post['location_selected']);
            } else {
                $this->model_extension_module_dosmap_locations->deleteLocation($this->request->post['location_data']);
            }
    ...
    * @return array $json
    */
	private function updateJSONFile($json, $module_json_coords, $module_id) {
		$this->load->language('extension/module/dosmap_locations');
        ...
        if ($module_json_coords) {
            ...
            foreach ($languages as $language_code => $language) {
                ...
                $results[$language['language_id']] = $this->model_extension_module_dosmap_locations->getLocations($filter_data);
            }
                ...
                foreach ($language as $result) {
                    $locations[$language_id]['features'][] = array(
                        ...
                        'properties' => array(
                            ...
                            'clusterCaption'       => '',
                            'hintContent'          => $result['title'] // when 'hover' on marker
                        )
                    );
                }
            }
    ...
    */
    private function demoData() {
        ...
        $demo_data['en'] = array(
            ...
            'baloon_body'   => '
&lt;div style=&quot;color: #000;&quot;&gt;
    &lt;div style=&quot;color: #999; font-size: 13px; line-height: 17px;&quot;&gt;Landmark&lt;/div&gt;
    &lt;hr style=&quot;margin: 10px 0;&quot;&gt;
    &lt;div&gt;
        &lt;a href=&quot;tel:+97148888888&quot; target=&quot;_blank&quot; style=&quot; font-size: 14px;&quot;&gt;+971 4 8888888&lt;/a&gt;
    &lt;/div&gt;
    &lt;div&gt;
        &lt;a href=&quot;https://www.burjkhalifa.ae/&quot; target=&quot;_blank&quot; style=&quot; font-size: 14px;&quot;&gt;https://www.burjkhalifa.ae/&lt;/a&gt;
    &lt;/div&gt;
    &lt;hr style=&quot;margin: 10px 0;&quot;&gt;
    &lt;div style=&quot;color: #000; font-size: 16px; line-height: 22px;&quot;&gt;Burj Khalifa, Downtown Dubai, Dubai Emirate&lt;/div&gt;
    &lt;div style=&quot;color: #999; font-size: 12px; padding: 5px 0;&quot;&gt;A supertall skyscraper in Dubai, UAE, with a height of 828 meters, it is the tallest and most multi-story building in the world, as well as the tallest structure. The stepped shape of the building resembles a stalagmite.&lt;/div&gt;
    &lt;hr style=&quot;margin: 10px 0;&quot;&gt;
    &lt;div&gt;
        &lt;div style=&quot;text-align: center;&quot;&gt;
            &lt;a href=&quot;https://www.openstreetmap.org/way/446646206&quot; target=&quot;_blank&quot; style=&quot;display: block; color: #000; font-size: 14px; background-color: #ffd633; padding: 5px 15px;&quot;&gt;About the object&lt;/a&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;hr style=&quot;margin: 10px 0;&quot;&gt;
&lt;/div&gt;
        ...
        $demo_data['ru'] = array(
            ...
            'baloon_body'   => '
&lt;div style=&quot;color: #000;&quot;&gt;
    &lt;div style=&quot;color: #999; font-size: 13px; line-height: 17px;&quot;&gt;Достопримечательность&lt;/div&gt;
    &lt;hr style=&quot;margin: 10px 0;&quot;&gt;
    &lt;div&gt;
        &lt;a href=&quot;tel:+97148888888&quot; target=&quot;_blank&quot; style=&quot; font-size: 14px;&quot;&gt;+971 4 8888888&lt;/a&gt;
    &lt;/div&gt;
    ...
    &lt;/div&gt;
    &lt;hr style=&quot;margin: 10px 0;&quot;&gt;
    &lt;div style=&quot;color: #000; font-size: 16px; line-height: 22px;&quot;&gt;Бурдж-Халифа, Даунтаун Дубай, эмират Дубай&lt;/div&gt;
    &lt;div style=&quot;color: #999; font-size: 12px; padding: 5px 0;&quot;&gt;Cверхвысотный небоскрёб высотой 828 метров в Дубае (ОАЭ), самое высокое и самое многоэтажное здание в мире, а также самое высокое сооружение. Уступчатая форма здания напоминает сталагмит.&lt;/div&gt;
    &lt;hr style=&quot;margin: 10px 0;&quot;&gt;
    &lt;div&gt;
        &lt;div style=&quot;text-align: center;&quot;&gt;
            &lt;a href=&quot;https://www.openstreetmap.org/way/446646206&quot; target=&quot;_blank&quot; style=&quot;display: block; color: #000; font-size: 14px; background-color: #ffd633; padding: 5px 15px;&quot;&gt;Об объекте&lt;/a&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;hr style=&quot;margin: 10px 0;&quot;&gt;
&lt;/div&gt;
        ...
        $demo_data['ua'] = array(
            ...
            'baloon_body'   => '
&lt;div style=&quot;color: #000;&quot;&gt;
    &lt;div style=&quot;color: #999; font-size: 13px; line-height: 17px;&quot;&gt;Визначна пам\'ятка&lt;/div&gt;
    &lt;hr style=&quot;margin: 10px 0;&quot;&gt;
    &lt;div&gt;
        &lt;a href=&quot;tel:+97148888888&quot; target=&quot;_blank&quot; style=&quot; font-size: 14px;&quot;&gt;+971 4 8888888&lt;/a&gt;
    &lt;/div&gt;
    ...
    &lt;/div&gt;
    &lt;hr style=&quot;margin: 10px 0;&quot;&gt;
    &lt;div style=&quot;color: #000; font-size: 16px; line-height: 22px;&quot;&gt;Бурдж-Халіфа, Даунтаун Дубай, емірат Дубай&lt;/div&gt;
    &lt;div style=&quot;color: #999; font-size: 12px; padding: 5px 0;&quot;&gt;Надвисокий хмарочос висотою 828 метрів у Дубаї (ОАЕ), найвища і багатоповерхова будівля у світі, а також найвища споруда. Поступкова форма будівлі нагадує сталагміт.&lt;/div&gt;
    &lt;hr style=&quot;margin: 10px 0;&quot;&gt;
    &lt;div&gt;
        &lt;div style=&quot;text-align: center;&quot;&gt;
            &lt;a href=&quot;https://www.openstreetmap.org/way/446646206&quot; target=&quot;_blank&quot; style=&quot;display: block; color: #000; font-size: 14px; background-color: #ffd633; padding: 5px 15px;&quot;&gt;Про об\'єкт&lt;/a&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;hr style=&quot;margin: 10px 0;&quot;&gt;
&lt;/div&gt;
    ...
    */
    public function install() {
        ...
        $this->model_extension_module_dosmap_locations->installModule($demo_array);
    }
    ...
    */
    public function uninstall() {
        ...
        if (!empty($this->config->get('module_dosmap_locations_data_delete'))) {
            $this->model_extension_module_dosmap_locations->uninstallModule();

            // Delete directories.
            $dirPath = DIR_IMAGE . 'module-dosmap_locations/';
            $this->deleteDir($dirPath);
        } else {
            $this->model_extension_module_dosmap_locations->deleteDemo();
        }
    }
