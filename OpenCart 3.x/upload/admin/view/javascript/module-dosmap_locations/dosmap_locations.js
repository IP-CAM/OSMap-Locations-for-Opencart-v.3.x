...
jQuery(function($) {
    ...
    $(document).ready(function() {
        ...
        $('#locations-list tbody button.edit').on('click', function() {
            ...
            if (tr.is('.editing')) {
                ...
                toggleSummernoteTextarea(tr, false);
                ...
                if (tr.is('.updated')) {
                    ...
                    toggleSummernoteTextarea(tr, true);
        ...
        // Add List Location.
        $('#tab-locations button.add_location-list').on('click', function() {
            $('#tabs-main a[href="#tab-add_location"]').click();
        });
    ...
    function messageAlertModal(success, message) {
        setTimeout(function() {
            ...
            html += '<div class="alert ' + (success ? 'alert-success' : 'alert-danger') + ' alert-dismissible" style="margin: 0 0 10px;">';
                html += '<i class="fa fa-exclamation-circle"></i> <span>' + message + '</span>';
    ...
    function toggleSummernoteTextarea(tr, status) {
        if (status) {
            var widthTD = tr.find('td.addition_info').width() - 20;

            tr.find('.field-baloon_body').data('toggle', 'summernote');
            tr.find('.field-baloon_body').attr('data-toggle', 'summernote');
            tr.find('.field-baloon_body').summernote({ width: widthTD, height: 230 });
        } else {
            tr.find('.field-baloon_body').data('toggle', '');
            tr.find('.field-baloon_body').removeAttr('data-toggle');
            tr.find('.field-baloon_body').summernote('destroy');
        }
    }
