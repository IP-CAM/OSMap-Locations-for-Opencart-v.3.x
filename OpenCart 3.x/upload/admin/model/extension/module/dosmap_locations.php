...
class ModelExtensionModuleDOSMapLocations extends Model {
    ...
    */
    public function addLocation($data, $module_id = 0) {
    ...
    */
    public function getLocationDescriptions($data) {
    ...
    * @return void
    */
    public function copyCurrentLanguageLocation($language_id_add) {
