...
class ControllerExtensionModuleDOSMapLocations extends Controller {
	public function index($setting) {
        if ($setting['status']) {
            ...
            $language_map = $setting['map_language'] ? $setting['map_language'] : 'osm';
            $language_map_custom = $setting['map_language_custom'] ? $setting['map_language_custom'] : 'osm';

            $language_code_map = 'osm';
            ...
            $pagination->url = $this->url->link($route, $url . '&dosmap_page={page}', true);
